...
public class Command extends BaseCommand {
    ...
    public static final String TYPE_PTZ_CONTROL = "ptzControl";
    public static final String TYPE_VIDEO_ATTRIBUTES_QUERY = "videoAttributesQuery";
    public static final String TYPE_VIDEO_RESOURCE_LIST_QUERY = "videoResourceListQuery";
